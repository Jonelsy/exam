...
export declare class ExamService {
    ...
    constructor(examRepository: Repository<Exam>, classExamRepository: Repository<ClassExam>, questionRepository: Repository<Question>, optionRepository: Repository<Option>);
